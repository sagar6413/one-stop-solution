...
classDiagram
    ...
    class UserPreferences {
        ...
        -String language
        +updatePreferences(UserPreferencesDTO) void
    }
    ...
    UserData "1" -- "1" UserProfile
    UserData "1" -- "1" UserPreferences
    UserData "1" -- "*" Itinerary
    UserData "1" -- "*" Post
    UserData "1" -- "*" Review
    Itinerary "1" -- "*" ItineraryItem
    Itinerary "1" -- "*" Collaboration
    ItineraryItem "1" -- "*" Expense
    Post "1" -- "*" Comment
    Post "1" -- "*" Like
